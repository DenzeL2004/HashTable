...
run: 	 obj/generals.o obj/log_errors.o obj/word_reader.o obj/list.o obj/main.o 
	g++  obj/generals.o obj/log_errors.o obj/word_reader.o obj/list.o obj/main.o -o run
