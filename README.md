...
3. Все тесты проводились с одними и теми же наборами данных: [words.txt](resource/words.txt) на 58108 уникальных слов, [test.txt](resource/test.txt) - файл с входными данными на тестирование, состоящий из 10 000 000 слов.
...
Абсолютный процент ускорения рассчитывается по формуле: $(1 - \frac{CurTime}{LastTime}) \cdot 100\%$.
